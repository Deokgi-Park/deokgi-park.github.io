...
.archive > h2{
  background: linear-gradient(to bottom, rgb(248 18 106 / 50%) 15px, transparent 1px) 0 0;
...
> _"**수만 명 규모 사용자 환경에서 유지보수와 장애 대응을 수행하며, 다양한 운영 환경에서도 원인 분석부터 해결까지 빠르게 실행하는 실전형 프론트/풀스택 개발자입니다.**"_{: style="word-break: auto-phrase;"}

<div style="word-break: auto-phrase; text-indent: -1.6em; padding-left: 1.6em;">
<p style="margin-bottom: 3px;">▶️ <code>Next.js</code> 와 같은 <code>React 기반 라이브러리</code>로 사용자 중심 서비스를 구현하며, 빠른 개발 동향에 맞춰 꾸준히 역량을 확장하고 있습니다.</p>
<p style="margin-bottom: 3px;">▶️ 3년간의 실무 및 유지보수 경험으로 <code>서버 환경과 오류 상황에 맞춰 대응하는 문제 해결 역량</code>을 길렀습니다.</p>
<p>▶️ 최근 <code>Claude Code</code>와 같은 AI 기반 개발 도구를 적극 활용해 생산성과 문제 해결 속도를 높이고 있습니다.
</p>
</div>
...
| 일일 미로 게임 | 2025.09           | Next.js, Cloudflare D1                        |
